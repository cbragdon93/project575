...
```{r report_3_mls}
# MLR
monthSeven.mls.categorical <- lm( TotalInteractions ~ PostHour + as.factor(Paid) + as.factor(Category) + as.factor(Type), 
                      data=monthSeven )
...
monthSeven.mls.notCategorical <- lm( TotalInteractions ~ PostHour + Pagetotallikes*LifetimeEngagedUsers)
